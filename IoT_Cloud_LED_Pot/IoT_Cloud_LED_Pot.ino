 ...
 *   IoT Cloud dashboard when the *DEBUG* flag is enabled.
 *
...
/**
 * @file IoT_Cloud_LED_Pot.ino
 *
 * @brief The primary Arduino sketch implementation file.
 *
 * @section description_iot_cloud_led_pot_ino Description
 * The primary Arduino sketch implementation file.
 *
 * @section libraries_iot_cloud_led_pot_ino Libraries
 * - *arduino_secrets.h* Local Header File
 *   - Contains the secrets (usernames, passwords, and other parameters) used
 *     for accessing the local WiFi network and the Arduino IoT Cloud service.
 * - *thingProperties.h* Local Header File
 *   - Contains the IoT Cloud configuration and connection details.
 ...
 *
 * @section notes_iot_cloud_led_pot_ino Notes
 * - Comments are Doxygen compatible.
 *
 * @section todo_iot_cloud_led_pot_ino TODO
 * - None.
 *
 * @section author_iot_cloud_led_pot_ino Author(s)
 * - Created by John Woolsey on 09/09/2023.
 * - Modified by John Woolsey on 10/12/2023.
 *
 * Copyright (c) 2023 Woolsey Workshop.  All rights reserved.
 */
...
#include "thingProperties.h"  // IoT Cloud configuration
...
void setup() {
   ...
   // Connect Arduino IoT Cloud
   ArduinoCloud.begin(ArduinoIoTPreferredConnection);

   // IoT Cloud debug messages
 ...
 */
void loop() {
   ArduinoCloud.update();  // synchronize IoT Cloud data
